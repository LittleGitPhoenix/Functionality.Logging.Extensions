...
internal static partial class LogScopeBuilder
{
	...
	)
	{
		static void TryAdd(Dictionary<string, object?> collection, string name, object? value, bool clean)
		{
			...
			* • Direct		: BuildScopeDictionary(MyEnum.EnumValue) ⇒ Name: MyEnum, Value: EnumValue
			* • Variable	: BuildScopeDictionary(myEnumVariable) ⇒ Name: MyEnumVariable, Value: EnumValue
			*/
