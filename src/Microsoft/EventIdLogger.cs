...
//    /// <param name="propertyName"> The name of the property under which the logger <paramref name="name"/> will be scoped. Default is <see cref="LoggerNameProperty"/>. </param>
//    protected EventIdLogger(ILogger logger, string name, string propertyName = LoggerNameProperty)
//        : this(logger)
//    {
//        if (String.IsNullOrWhiteSpace(propertyName)) propertyName = LoggerNameProperty;
...
//	/// <inheritdoc cref="LoggerExtensions.Log(ILogger, int, LogLevel, string, object?[])"/>
