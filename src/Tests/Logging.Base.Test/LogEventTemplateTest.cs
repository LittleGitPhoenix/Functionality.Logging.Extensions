...
#pragma warning restore 8618
	...
	interface IMyLogEvent : ILogEvent<MyLogLevel, int>;

	class MyLogEvent : LogEvent<MyLogLevel, int>, IMyLogEvent
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public MyLogEvent(int eventId, MyLogLevel logLevel, string logMessage, params object?[] args)
		...
		/// <param name="logMessage"> <inheritdoc cref="ILogEvent{TLogLevel,TEventId}.LogMessage"/> </param>
		/// <param name="args"> <inheritdoc cref="ILogEvent{TLogLevel,TEventId}.Args"/> </param>
		public MyLogEvent(int eventId, Exception exception, MyLogLevel logLevel, string logMessage, params object?[] args)
			: base(eventId, exception, logLevel, logMessage, args) { }
	}

	class MyLogEventTemplate : LogEventTemplate<IMyLogEvent, MyLogLevel, int>
	{
		/// <inheritdoc />
		[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		protected override IMyLogEvent CreateLogEvent(int eventId, string logMessage, MyLogLevel actualLogLevel, Exception? exception, IPayload? payload, params object?[] argsArray)
			=> CreateLogEvent_Internal(eventId, logMessage, actualLogLevel, exception, payload, argsArray);

		[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		internal static IMyLogEvent CreateLogEvent_Internal(int eventId, string logMessage, MyLogLevel actualLogLevel, Exception? exception, IPayload? payload, params object?[] argsArray)
		{
			return exception is null
				? new MyLogEvent(eventId, actualLogLevel, logMessage, argsArray) { Payload = payload }
				: new MyLogEvent(eventId, exception, actualLogLevel, logMessage, argsArray) { Payload = payload }
				;
		}
	}

	class MyLogEventTemplate<TArgs> : LogEventTemplate<IMyLogEvent, MyLogLevel, int, TArgs>
...
#endif
	{
		...
		[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		protected override IMyLogEvent CreateLogEvent(int eventId, string logMessage, MyLogLevel actualLogLevel, Exception? exception, IPayload? payload, params object?[] argsArray)
			=> MyLogEventTemplate.CreateLogEvent_Internal(eventId, logMessage, actualLogLevel, exception, payload, argsArray);
	...
	public void LogEventTemplatePropertiesAreInitializedCorrectly()
	{
		...
		// Act
		var template = new MyLogEventTemplate
		{
			EventId = eventId,
			LogLevel = logLevel,
		...
		Assert.That(template.EventId, Is.EqualTo(12345));
	...
	public void LogEventTemplateGenericPropertiesAreInitializedCorrectly()
	{
		...
		// Act
		var template = new MyLogEventTemplate<(int UserId, string Action)>
		{
			EventId = eventId,
			LogLevel = logLevel,
			LogMessage = logMessage,
		...
		// Assert
		Assert.That(template.EventId, Is.EqualTo(eventId));
		Assert.That(template.EventId, Is.EqualTo(67890));
		Assert.That(template.LogLevel, Is.EqualTo(logLevel));
		Assert.That(template.LogMessage, Is.EqualTo(logMessage));
	}
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int UserId, string? UserName)>
		{
			EventId = 11111,
		...
		// Assert
		Assert.That(logEvent.EventId, Is.EqualTo(11111));
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(string? FirstName, string? LastName, int? Age)>
		{
			EventId = 22222,
		...
		// Assert
		Assert.That(logEvent.EventId, Is.EqualTo(22222));
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int UserId, string? Email, string UserName, int? Age)>
		{
			EventId = 33333,
		...
		// Assert
		Assert.That(logEvent.EventId, Is.EqualTo(33333));
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int First, string Second, bool Third, double Fourth)>
		{
			EventId = 44444,
			LogLevel = MyLogLevel.Information,
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int IntVal, long LongVal, byte ByteVal, short ShortVal, decimal DecimalVal)>
		{
			EventId = 55555,
			LogLevel = MyLogLevel.Information,
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(string StringVal, object ObjectVal, DateTime DateVal)>
		{
			EventId = 66666,
			LogLevel = MyLogLevel.Information,
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(string Message, Unit)>
		{
			EventId = 77777,
			LogLevel = MyLogLevel.Information,
			LogMessage = "{Message}",
	...
	public void ArgsArrayHandlesMultipleUnitsCorrectly()
	{
		...
		var template = new MyLogEventTemplate<(Unit, Unit, Unit)>
		{
			EventId = 77777,
			LogLevel = MyLogLevel.Information,
			LogMessage = "{Message}",
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(List<int> Numbers, Dictionary<string, object> Metadata)>
		{
			EventId = 88888,
			LogLevel = MyLogLevel.Information,
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int Id, string Name)>
		{
			EventId = 99999,
			LogLevel = MyLogLevel.Information,
			LogMessage = "{Id}, {Name}",
	...
	public void TupleTypeVerificationSucceeds()
	{
		...
		(
			() =>
			{
				...
				_ = new MyLogEventTemplate<(int UserId, string UserName)>
				{
					EventId = 69544843,
					LogLevel = MyLogLevel.Information,
	...
	public void LogEventTemplateCanBeCreated()
	{
		...
		(
			() =>
			{
				...
				Assert.That(logEvent.EventId, Is.EqualTo(69544843));
				Assert.That(logEvent.LogLevel, Is.EqualTo(MyLogLevel.Information));
		...
		(
			() =>
			{
				_ = new MyLogEventTemplate<(int UserId, Unit)>
				{
					EventId = 242615004,
					LogLevel = MyLogLevel.Information,
	...
	#region Non-Generic Build Overloads

	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildUsesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		var message = "Test message";
		var template = new MyLogEventTemplate { EventId = id, LogLevel = level, LogMessage = message };
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithExceptionUsesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Error;
		var message = "Error message";
		var template = new MyLogEventTemplate { EventId = id, LogLevel = level, LogMessage = message };
		var exception = new InvalidOperationException("Test error");

		// Act
		var logEvent = template.Build(exception);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithExceptionPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Error;
		...
		// Act
		var logEvent = template.Build(exception, payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithLogLevelOverridesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		var message = "Test message";
		var template = new MyLogEventTemplate { EventId = id, LogLevel = level, LogMessage = message };
		var overrideLevel = MyLogLevel.Debug;

		// Act
		var logEvent = template.Build(overrideLevel);

		// Assert
		Assert.That(logEvent.EventId, Is.EqualTo(id));
		Assert.That(logEvent.LogLevel, Is.EqualTo(overrideLevel));
		Assert.That(logEvent.Exception, Is.Null);
		Assert.That(logEvent.Payload, Is.Null);
	}
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithLogLevelPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(overrideLevel, payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithLogLevelAndExceptionOverridesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		var message = "Test message";
		var template = new MyLogEventTemplate { EventId = id, LogLevel = level, LogMessage = message };
		var overrideLevel = MyLogLevel.Error;
		var exception = new InvalidOperationException("Test error");

		// Act
		var logEvent = template.Build(overrideLevel, exception);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void NonGenericBuildWithLogLevelAndExceptionPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(overrideLevel, exception, payload);
	...
	#region Generic Build Overloads

	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildUsesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Information;
		var message = "User {UserId} with name {UserName}";
		var template = new MyLogEventTemplate<(int UserId, string UserName)> { EventId = id, LogLevel = level, LogMessage = message };
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Information;
		...
		// Act
		var logEvent = template.Build(args, payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithExceptionUsesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Error;
		var message = "User {UserId} caused error";
		var template = new MyLogEventTemplate<(int UserId, string UserName)> { EventId = id, LogLevel = level, LogMessage = message };
		var args = (UserId: 42, UserName: "John");
		var exception = new InvalidOperationException("Test error");

		// Act
		var logEvent = template.Build(args, exception);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithExceptionPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Error;
		...
		// Act
		var logEvent = template.Build(args, exception, payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithLogLevelOverridesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(args, overrideLevel);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithLogLevelPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(args, overrideLevel, payload);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithLogLevelAndExceptionOverridesPreDefinedLogLevel()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(args, overrideLevel, exception);
	...
	[Test]
	[Category("LogEventBuilding")]
	public void GenericBuildWithLogLevelAndExceptionPropagatesPayload()
	{
		// Arrange
		var id = _fixture.Create<int>();
		var level = MyLogLevel.Warning;
		...
		// Act
		var logEvent = template.Build(args, overrideLevel, exception, payload);
	...
	public void LogEventWithSingleParameterCanBeBuild()
	{
		...
		var template = new MyLogEventTemplate<(int UserId, Unit)>
		{
			EventId = id,
			LogLevel = level,
			LogMessage = message,
				...
				(
					() =>
					{
						try
						{
							...
							{
								var logEvent = template.Build();
								Assert.That(logEvent.EventId, Is.EqualTo(12345));
								Assert.That(logEvent.LogLevel, Is.EqualTo(MyLogLevel.Information));
								Assert.That(logEvent.LogMessage, Is.EqualTo("Concurrent test message"));

								var logEventWithLevel = template.Build(MyLogLevel.Debug);
								Assert.That(logEventWithLevel.LogLevel, Is.EqualTo(MyLogLevel.Debug));
	...
	{
		// Arrange
		var template = new MyLogEventTemplate<(int RequestId, Unit)>
		{
			EventId = 99999,
			LogLevel = MyLogLevel.Debug,
					...
					() =>
					{
						try
						{
							for (var i = 0; i < iterationsPerThread; i++)
							{
								...
								var logEvent = template.Build(args);
								Assert.That(logEvent.EventId, Is.EqualTo(99999));
								Assert.That(logEvent.Args, Has.Length.EqualTo(1));
					...
					() =>
					{
						try
						{
							for (var i = 0; i < iterationsPerThread; i++)
							{
								...
								var logEvent = template.Build(args);
								Assert.That(logEvent.EventId, Is.EqualTo(67890));
								Assert.That(logEvent.LogLevel, Is.EqualTo(MyLogLevel.Warning));
								Assert.That(logEvent.Args, Has.Length.EqualTo(2));
								Assert.That(logEvent.Args[0], Is.EqualTo(args.UserId));
								Assert.That(logEvent.Args[1], Is.EqualTo(args.UserName));

								var logEventWithLevel = template.Build(args, MyLogLevel.Error);
								Assert.That(logEventWithLevel.LogLevel, Is.EqualTo(MyLogLevel.Error));
