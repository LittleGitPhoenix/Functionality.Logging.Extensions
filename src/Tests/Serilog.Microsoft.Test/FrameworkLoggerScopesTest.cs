...
//	private class TestExecutionContextAwareScope : Phoenix.Functionality.Logging.Base.IExecutionContextAwareLogScope
//	{
...
//		{
//			if (obj is TestExecutionContextAwareScope other)
//			{
