...
public static class LoggerSinkConfigurationExtensions
{
    ...
    )
    {
        ...
        var (sink, evaluationFunction) = SerilogSeqSinkHelper.CreateSink(seqHost, seqPort, applicationTitle, configurationApiKey, retryOnError, retryCount, controlLevelSwitch, batchPostingLimit, period, eventBodyLimitBytes, messageHandler, queueSizeLimit, selfLogger);
