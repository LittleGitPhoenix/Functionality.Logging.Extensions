...
namespace Serilog.File.Test
{
	public class ArchiveHookTest
	{
		...
		public void Check_If_Archiving_File()
		{
			...
			// Act
			var zipFile = ArchiveHook.CreateZipFile(logFile, CompressionLevel.Optimal, testDirectory.Directory);
		...
		public void Check_If_Archiving_File_To_Another_Directory()
		{
			...
			// Act
			var zipFile = ArchiveHook.CreateZipFile(logFile, CompressionLevel.Optimal, archiveDirectory);
